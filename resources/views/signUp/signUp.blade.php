...
<body>
    <main class="form-signin w-100 m-auto">
        <form action="/simpan_signUp" method="POST" onsubmit="return validateForm()"> 
            @csrf 
            ...
            <p class="mt-3 mb-3 text-center text-body-secondary">Already have account? <a href=/signIn>Sign In</a></p>
        </form>
    </main>
</body>
</html>
